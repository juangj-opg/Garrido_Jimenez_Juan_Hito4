...
<body class="hold-transitio sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src=" {{ asset('/storage/IESP_Sur_Logo.png') }}" alt="IESPSur Logo" height="100" width="100">
  </div> -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-header">Incidencias</li>
            <li class="nav-item">
              <a href="/newIncidence" class="nav-link">
            ...
            <li class="nav-item">
              <a href="/openIncidences/{{auth()->user()->id}}" class="nav-link"> <!-- Dar fix a esto -->
          ...
          <li class="nav-item">
            <a href="/datosPersonales/{{auth()->user()->id}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link">
              ...
              <p><b>WIP - </b> Historial de Incidencias</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p><b>WIP -</b> Cambiar datos</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="#" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p><b>WIP - </b> Cambiar contraseña</p>
            </a>
          </li>
          @endif
          @endauth
